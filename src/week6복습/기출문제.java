...
//
//import static week6_1.Solution.rndOp;
//
//public class 기출문제 {
//    // ************************************************************************
//    // 1. 100미만의 임의의 0 이상의 정수를 반환하는 메소드(rndInt())를 구현하시오.
...
//
//    // ************************************************************************
//    // 2. 정수의 기본 연산자들 "+", "-", "*", "/", "%" 중 임의의 연산자를 반환하는
//    //    메소드(rndOp())을 구현하시오.
//    public static void String rndOp() {
...
//
//    // ************************************************************************
//    // 3. 매개변수 n의 갯수 만큼의 임의의 정수(10이상 100미만) 배열을 반환하는
...
//
//    // ************************************************************************
//    // 4. void getOpList(String[] strL, int n)을 구현하는데 이는
...
//
//    // ************************************************************************
//    // 5. 매개변수의 파일명의 파일을 열고 매개변수 n의 갯수만큼 읽어서
...
//
//        // ***********************************************************************
//        // 7.  한번의 반복문을 통해 n2List의 최대와 평균 값을 구하고 결과를 출력하세요.
...
//                    max = n2List[i];
//            }
//            System.out.println("최대값 =" + max + ", 평균값 =" + sum/10.0);
//
